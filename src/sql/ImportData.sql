...
-- Need decoded password -> throw error is the password did not encode
...
(1, 1, 2, 'Blue Buffalo Life Protection Formula Natural Adult Dry Dog Food, Chicken and Brown Rice 5-lb Trial Size Bag', , 'https://m.media-amazon.com/images/I/81qYRubwRpL._AC_UL600_FMwebp_QL65_.jpg', 'USD'),
...
create table if not exists product_detail_flavors (
  ...
  primary key (product_detail_id, ppet_food_flavors),
...
Apple, Turkey, Pumpkin, Liver, Lamb
